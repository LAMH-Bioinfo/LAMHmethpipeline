...
sample_name <- 'Case_control'
work_dir <- '/shared/MingmaData/Colon_case_control_574samples/fragment_80_140/all_MBS_deeptools_80_140/'
file_name_meth <- paste(sample_name, '_methratio_deeptools_size_80_140_sorted_MBS.csv', sep = '')
file_name_coverage <- paste(sample_name, '_coverage_deeptools_size_80_140_sorted_MBS.csv', sep = '')
file_appendix <- '_CHALM_region_MBS_combined_length_80_140_selected.bed'
